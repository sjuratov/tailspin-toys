...
- Comment the reason for non-obvious fixtures or setup; do not add comments that
  merely restate the test or assertion.
- Keep test comments current when the behavior or fixture contract changes. See
